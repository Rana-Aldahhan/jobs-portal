        ...
        <ul class="navbar-nav  mr-auto "  >
            ...
            <li class="nav-item ">
                <a href="/notifications">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill=" currentColor" class="bi bi-bell-fill" viewBox="0 0 16 16"style="margin-top:30px; color: #D7CCC8;"
                         id="notification_number">
                        <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2zm.995-14.901a1 1 0 1 0-1.99 0A5.002 5.002 0 0 0 3 6c0 1.098-.5 6-2 7h14c-1.5-1-2-5.902-2-7 0-2.42-1.72-4.44-4.005-4.901z"/>
                    </svg>
                </a>
                @if($newNotifications) <span class="badge badge-notify">{{$notificationCount}} </span>@endif
            </li>
            <li class="nav-item ">
                <a href="/messeging">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-chat-dots-fill" viewBox="0 0 16 16"style="margin-top:30px;margin-left:8px; color:#D7CCC8;">
                        <path d="M16 8c0 3.866-3.582 7-8 7a9.06 9.06 0 0 1-2.347-.306c-.584.296-1.925.864-4.181 1.234-.2.032-.352-.176-.273-.362.354-.836.674-1.95.77-2.966C.744 11.37 0 9.76 0 8c0-3.866 3.582-7 8-7s8 3.134 8 7zM5 8a1 1 0 1 0-2 0 1 1 0 0 0 2 0zm4 0a1 1 0 1 0-2 0 1 1 0 0 0 2 0zm3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/>
                    </svg>
                </a>
                @if($newMessages)<span class="badge badgeMessage-notify">{{$messagesCount}} </span>@endif
            </li>
        </ul>
    </div>
...
box-shadow: none;">
            ...
            <li class="nav-item ">
                ...
                @if($newCompanyNotifications) <span class="badge badge-notify" style="margin-bottom: -30px;margin-left: -15px">{{$companyNotificationCount}}</span>@endif
            </li>
            <li class="nav-item ">
                ...
                @if($newCompanyMessages)<span class="badge badgeMessage-notify" style="margin-bottom: -30px;margin-left: -15px">{{$companyMessagesCount}} </span>@endif
            </li>
        </ul>
    </div>
</nav>
