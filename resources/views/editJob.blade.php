                    ...
                    <div class="container">
                        <div class="row">
                            <div class="card d-flex justify-content-center mx-auto my-3 p-5">
                                ...
                                <div class="form-group col-md-6 first  @error('title') is-invalid @enderror"> <label for="inputFirstName">Title job" <span>*</span></label> <input type="text" class="form-control @error('title') is-invalid @enderror" id="inputtitlejob" name="title"  value="{{$job->title}}" required>
                                    @error('title')
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" value="1" @if($job->remote) checked @endif  name="remote">
                                ...
                                <div class="form-group col-md-6 first">
                                    <label for="inputLastName  @error('role') is-invalid @enderror">Role<span>*</span>
                                    </label> <input type="text" class="form-control  @error('role') is-invalid @enderror" id="inputrole" name="role" value="{{$job->role}}">
                                    @error('role')
                                ...
                                <div class="form-group col-md-6 first">
                                    ...
                                    <select data-placeholder="Job industry"  class="chosen-select  form-select mt-3 form-control" name="industry" >
                                ...
                                <div class="form-group col-md-6 first">
                                    ...
                                    </label> <input type="text" class="form-control @error('experience') is-invalid @enderror" id="inputrequiredexperience" name="experience" value="{{$job->required_experience}}">
                                    @error('experience')
                                ...
                                <div class="form-group col-md-6 first">
                                    ...
                                    </label> <input type="text" class="form-control @error('salary') is-invalid @enderror" id="inputsalary" name="salary" value="{{$job->salary}}">
                                    @error('salary')
                                ...
                                <div class="form-check form-check-inline"> <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="1" checked> <label class="form-check-label" for="inlineCheckbox1">&nbsp;&nbsp;I Agree To The Terms & Conditions</label> </div>
