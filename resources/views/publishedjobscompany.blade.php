...
<body>
 ...
 @endsection
   ...
   <h2 style="text-align: center;" >All the published freelancers by this account</h2>
   <br>



     <div class="card w-75" style="margin-left: 85px">
     <div class="card-body">
     <div class="row">
          ...
          <div class="d-flex justify-content-center align-items-center border border-info rounded-circle  " style="height: 140px; background-color: rgb(233, 236, 239);">
            <span style="color: rgb(166, 168, 170); font: bold 8pt Arial;"  ></span>
                   ...
                   <div class="col-lg-4 col-sm-auto mb-3">
                    ...
                    <label> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-brush" viewBox="0 0 16 16">
                     ...
                     <hr>
                     <a class="nav-link" href="#">
                    <label> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                     ...
                     <hr>
                     <a class="nav-link" href="#">
                    <label> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">
