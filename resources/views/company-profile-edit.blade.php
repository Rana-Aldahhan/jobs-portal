                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group col-md-8 ">
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="validationCustom02" placeholder="name of the company" value="{{$company->name}}" name="name" required>
                                @error('name')
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        <input type="text" class="form-control  @error('country') is-invalid @enderror" id="validationCustom01" placeholder="country" value="{{$company->country}}" name="country" required>
                        @error('country')
                ...
                <div class="col-md-4 mb-3">
                    <form action="/action_page.php">
                        <div class="custom-file mb-3">
                            <input type="file" id="myFile" name="certificate" class="@error('certificate') is-invalid @enderror"
